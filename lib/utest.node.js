...
var UAction = /** @class */ (function (_super) {
    ...
    function UAction(mix, suite, parent) {
        ...
        _this = _super.call(this, mix, suite, parent) || this;
        return _this;
    }
...
var AtmaAction = {
    ...
    process: function (setts, done) {
        ...
        node_vars_1.NodeVars.suite = new Suite_1.RunnerSuite(node_vars_1.NodeVars.configs, __assign(__assign({}, setts), { isAction: true }));
