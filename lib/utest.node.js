...
exports.watch = function (base, resources, callback) {
    ...
    var watching = resources.map(function (url) {
...
var RunnerSuite = /** @class */ (function () {
    ...
    RunnerSuite.prototype.onComplete = function () {
        ...
        var resources = cfg_1.watch(this.base, this.getResources(), function (path) {
            ...
            var message = dateStr + "  modified " + str_1.color(templateObject_3 || (templateObject_3 = __makeTemplateObject(["bold<", ">"], ["bold<", ">"])), path);
            if (_this.isIdle() === false) {
                vars_1.logger.log(message);
                vars_1.logger.log('... but the RunnerSuite is not yet idle');
            }
            logger_1.log_clearStd();
            vars_1.logger.log(message);
            _this.runTests();
        });
        vars_1.logger.log(str_1.color(templateObject_4 || (templateObject_4 = __makeTemplateObject(["yellow< - watcher active. ", " Files>"], ["yellow< - watcher active. ", " Files>"])), resources.length));
    };
