...
var Runner = /** @class */ (function (_super) {
    ...
    function Runner(config, settings) {
        ...
        _this.isAction = (_b = (_a = settings) === null || _a === void 0 ? void 0 : _a.isAction, (_b !== null && _b !== void 0 ? _b : false));
        _this.config = config;
    ...
    Runner.prototype.notifyTest = function (url) {
        ...
        vars_1.logger.log(str_1.color(templateObject_1 || (templateObject_1 = __makeTemplateObject(["", ": bold<cyan<", ">>"], ["", ": bold<cyan<", ">>"])), this.isAction ? "Tasks" : "Test", name));
    ...
    Runner.prototype.onComplete = function (stats) {
        ...
        if (this.isAction !== true) {
            ...
            vars_1.logger
                .log(str_1.color(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n\nbold<", "<Completed> in ", "ms>"], ["\\n\\nbold<", "<Completed> in ", "ms>"])), failed ? 'red' : 'green', time));
        }
        this.failed = failed;
        this.stats = stats;
    ...
    Runner.prototype.onFailure = function (data) {
        ...
        if ('actual' in data || 'expected' in data) {
            ...
            if (typeof expect === 'string'
                ...
                vars_1.logger.log(str_1.color(templateObject_7 || (templateObject_7 = __makeTemplateObject(["", ""], ["", ""])), msg), data.actual, data.expected);
            }
        }
        if (data.message && data.generatedMessage !== true)
            vars_1.logger.log(str_1.color(templateObject_8 || (templateObject_8 = __makeTemplateObject([" bold<red<::>> "], [" bold<red<::>> "]))) + data.message.yellow);
        if (data.file && data.line != null) {
            ...
            if (vars_1.io.File.exists(uri)) {
                ...
                vars_1.logger
                    .log(str_1.color(templateObject_9 || (templateObject_9 = __makeTemplateObject(["  bold<", ">"], ["  bold<", ">"])), path))
                    .log(str_1.color(templateObject_10 || (templateObject_10 = __makeTemplateObject(["  bold<cyan< \u2192 >> bold<", " |> bold<red< ", " >>"], ["  bold<cyan< \u2192 >> bold<", " |> bold<red< ", " >>"])), data.line + 1, code))
                    .log('');
            }
            return;
        }
    ...
    Runner.prototype.onSuccess = function () {
        process.stdout.write(str_1.color(templateObject_11 || (templateObject_11 = __makeTemplateObject(["bold<green< |>>"], ["bold<green< |>>"]))));
    };
    return Runner;
...
var RunnerSuite = /** @class */ (function () {
    function RunnerSuite(configs, settings) {
        ...
        this.isAction = (_b = (_a = settings) === null || _a === void 0 ? void 0 : _a.isAction, (_b !== null && _b !== void 0 ? _b : false));
...
;
	...
	if (isObject(_src_UAction) && isObject(module.exports)) {
...
if ((_a = vars_1.global.atma) === null || _a === void 0 ? void 0 : _a.utest_action) {
    ...
    (_c = vars_1.global.atma, (_c !== null && _c !== void 0 ? _c : {})).utest_action = AtmaAction;
}
;
