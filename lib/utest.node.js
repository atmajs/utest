...
(function(){
	...
	(function (global) {
		...
		function case_hasAsyncCallback(fn) {
			...
			var str = fn.toString().replace(fn.name, "")
	...
	(function () {
	    RunnerNode = Class({
	        ...
	        Self: {
	            ...
	            process: (function (_process) {
	                ...
	                this.notifyTest(url);
	                var resource = include.cfg("path", _suite.base).instance(url).js(url).done(function (resp) {
	        ...
	        getResources: function getResources() {
	            ...
	            Object.keys(require.cache).filter(function (x) {
	    ...
	    var _nodeBuiltIns = ["assert", "async_hooks", "buffer", "child_process", "cluster", "console", "constants", "crypto", "dgram", "dns", "domain", "events", "fs", "http", "http2", "https", "inspector", "module", "net", "os", "path", "perf_hooks", "process", "punycode", "querystring", "readline", "repl", "stream", "string_decoder", "timers", "tls", "tty", "url", "util", "v8", "vm", "zlib"];
	})();
