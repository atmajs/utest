...
export const script_insert = (function() {
...
export function script_insertMany (bundle, callback){
	if (!(is_Array(bundle) && bundle.length)) {
		callback();
		return;
	}
...
export function script_getResources  () {
